...
from agent.prompt_builder import DEFAULT_AGENT_IDENTITY, DELEGATION_DISCLOSURE_GUIDANCE
...
class TestBuildSystemPrompt:
    ...
    def test_includes_delegation_disclosure_guidance_when_delegate_tool_loaded(self):
        with (
            patch(
                "run_agent.get_tool_definitions",
        ...
        prompt = agent._build_system_prompt()
        assert DELEGATION_DISCLOSURE_GUIDANCE in prompt
